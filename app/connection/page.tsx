...
import VerifyingAccounts from "./verify/page";
...
export default function ConnectAccountStatus() {
  ...
  const [solAddress] = useState("0xda5F0...6g56");
  ...
  const handleContinue = () => {
    if (walletConnected && solConnected && twitterConnected) {
      setIsVerifying(true);
    }
  };
          ...
          >
            <div className="max-w-md w-full mx-auto p-6 text-white space-y-4 rounded-lg text-center">
              ...
              <div className="flex justify-center">
                <button
                  className="w-[468px] h-[55px] py-3 px-4 bg-[#7B42FF] text-white rounded-lg hover:bg-[#9953FF] disabled:bg-[#171717] cursor-pointer"
                  disabled={
                    !walletConnected || !solConnected || !twitterConnected
                  }
